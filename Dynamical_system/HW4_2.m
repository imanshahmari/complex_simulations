...
currentTime = 0;
for i=1:maxTime
    xNext = NextX(xList(i),yList(i),timeStep,alfa,beta,delta,gamma);
    yNext = NextY(xList(i),yList(i),timeStep,alfa,beta,delta,gamma);
    xList(i+1) = xList(i)+ (alfa*xNext -beta*xNext*yNext)*timeStep;
    yList(i+1) = yList(i) +(delta*xNext*yNext-gamma*yNext)*timeStep;
